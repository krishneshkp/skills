...
- **[HIGH]** No naked `href="#"` links — unless the element genuinely acts as a button, in which case it should be a button or carry `role="button"` + keyboard handling. [S+J] — Webflow publishes unset CMS link fields as hidden `href="#"` anchors (`w-condition-invisible`); crawl.js excludes them — don't flag.
